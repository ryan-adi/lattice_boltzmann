        ...
        for yi in range(n_offset, self.lb.ny-n_offset):
            for xi in range(n_offset, self.lb.nx-n_offset):
                ...
                if (self.lb.wall[yi, xi]):
                    ...
                    # Push densities back 
                    self.lb.f[yi+1, xi, 2] = f[yi, xi, 4]
                    self.lb.f[yi, xi, 4] = f[yi, xi, 2]
                    self.lb.f[yi, xi-1, 1] = f[yi, xi, 3]
                    self.lb.f[yi, xi+1, 3] = f[yi, xi, 1]
                    self.lb.f[yi+1, xi+1, 5] = f[yi, xi, 7]
                    self.lb.f[yi+1, xi-1, 6] = f[yi, xi, 8]
                    self.lb.f[yi-1, xi+1, 8] = f[yi, xi, 6]
                    self.lb.f[yi-1, xi-1, 7] = f[yi, xi, 5]
                    
                    # Clear the densities in the wall cells
                    for fi in self.lb.f[yi, xi,:]:
                        fi = 0